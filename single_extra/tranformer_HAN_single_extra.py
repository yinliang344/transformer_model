...
class HAN_model():
    def __init__(self):
        ...
        with tf.name_scope('classifier'):
            self.all_weight = tf.concat([self.sq_atten,self.sx_float,self.xb_int,
                                         self.jycd_int,self.qkzm_int,
                                         self.jl_int,self.je_int,self.qj_int,
                                         self.hg_int,self.rztd_int],axis=-1)
